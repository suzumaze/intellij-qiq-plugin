...
public class QiqEchoBlockImpl extends ASTWrapperPsiElement implements QiqEchoBlock {

  public QiqEchoBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QiqVisitor visitor) {
    visitor.visitEchoBlock(this);
  }
