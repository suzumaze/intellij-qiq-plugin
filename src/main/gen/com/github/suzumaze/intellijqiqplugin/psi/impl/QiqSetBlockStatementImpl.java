...
public class QiqSetBlockStatementImpl extends ASTWrapperPsiElement implements QiqSetBlockStatement {

  public QiqSetBlockStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
